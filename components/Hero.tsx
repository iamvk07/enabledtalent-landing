  ...
  return (
    <section className="relative pt-32 pb-20 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-[#f0a500]/[0.04] rounded-full blur-[120px]" />
        <div className="absolute top-20 right-0 w-[400px] h-[400px] bg-[#818cf8]/[0.04] rounded-full blur-[100px]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Left: copy */}
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#f0a500]/30 bg-[#f0a500]/10 mb-8">
              <span className="w-1.5 h-1.5 rounded-full bg-[#f0a500] animate-pulse" />
              <span className="text-[11px] font-semibold text-[#f0a500] tracking-widest uppercase">Employment Infrastructure</span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-[56px] font-bold leading-[1.08] tracking-tight text-white mb-6">
              The Employment{' '}
              <span className="text-[#f0a500]">Infrastructure Layer</span>{' '}
              for Workforce Inclusion.
            </h1>

            <p className="text-[17px] text-[#94a3b8] leading-relaxed mb-10 max-w-[500px]">
              One system. Built for every stakeholder — talent, employers, universities, governments, and NGOs. Real jobs. Measurable impact.
            </p>

            <div className="flex flex-wrap gap-3">
              <a
                href="#contact"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-semibold text-[#07071a] bg-[#f0a500] hover:bg-[#f5bc3a] transition-colors text-sm"
              >
                Schedule a Demo
              ...
              <a
                href="#solutions"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-semibold text-white border border-white/[0.12] hover:border-white/25 hover:bg-white/[0.04] transition-all text-sm"
              >
                See How It Works
              </a>
            </div>
            ...
            {/* Social proof */}
            <p className="mt-8 text-[12px] text-[#475569] uppercase tracking-widest font-medium">
              Trusted by organizations building the future of work
            </p>
            <div className="mt-4 flex items-center gap-6 flex-wrap">
              {['NVIDIA', 'AWS', 'Microsoft', 'UNICEF', 'betakit'].map(logo => (
                <span key={logo} className="text-[13px] font-semibold text-[#475569] hover:text-[#94a3b8] transition-colors cursor-default">
                  {logo}
                </span>
              ))}
            </div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative rounded-2xl border border-white/[0.08] bg-[#0d0d24] overflow-hidden shadow-2xl shadow-black/50">
              {/* Fake browser chrome */}
                ...
                <div className="flex items-end gap-2 h-24 mb-4">
                  {[40, 55, 45, 70, 60, 85, 75, 90, 80, 87].map((h, i) => (
                    <div key={i} className="flex-1 rounded-sm" style={{
                      height: `${h}%`,
                      background: i === 9 ? '#f0a500' : `rgba(240,165,0,${0.15 + i * 0.04})`
                    }} />
                  ))}
                </div>
